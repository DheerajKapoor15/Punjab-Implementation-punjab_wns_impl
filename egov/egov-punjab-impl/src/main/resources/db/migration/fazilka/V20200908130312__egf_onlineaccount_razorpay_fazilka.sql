...
update chartofaccounts set name = 'RAZORPAY Bank Fazilka branch-919010025281358' where glcode='4502001';
update bankaccount set narration ='acc_FUyE4bP5QZcTA3' where accountnumber='919010025281358';

...
update chartofaccounts set name = 'RAZORPAY Bank Goniana branch-918010064572665' where glcode='4502101';
update bankaccount set narration ='acc_FVMmzsWLx4iysQ' where accountnumber='918010064572665';
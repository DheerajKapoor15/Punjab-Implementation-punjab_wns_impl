...
update chartofaccounts set name = 'RAZORPAY Bank Balachaur branch-918020068732040' where glcode='4502101';
update bankaccount set narration ='acc_FaSV4YIFAAHPh1' where accountnumber='918020068732040';
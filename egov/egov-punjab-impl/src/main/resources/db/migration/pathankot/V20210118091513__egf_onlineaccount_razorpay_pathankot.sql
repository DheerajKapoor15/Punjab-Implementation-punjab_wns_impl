...
update chartofaccounts set name = 'RAZORPAY Bank Pathankot branch-919010072883217' where glcode='4502001';
update bankaccount set narration ='acc_FUyk8jW7JDLJbA' where accountnumber='919010072883217';

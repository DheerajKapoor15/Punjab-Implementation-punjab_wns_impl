...
update chartofaccounts set name = 'RAZORPAY Bank Sirhind branch-918020070288456' where glcode='4502101';
update bankaccount set narration ='acc_G4Tqh9nekFzLoe' where accountnumber='918020070288456';  
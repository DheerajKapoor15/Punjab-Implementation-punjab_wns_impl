...
update chartofaccounts set name = 'RAZORPAY Bank Sangrur branch-918010069724340' where glcode='4502101';
update bankaccount set narration ='acc_FVM6PRfP2uAcjw' where accountnumber='918010069724340'; 
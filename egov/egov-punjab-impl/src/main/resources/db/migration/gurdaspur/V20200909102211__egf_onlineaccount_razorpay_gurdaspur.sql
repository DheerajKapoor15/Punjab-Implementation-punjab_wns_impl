...
update chartofaccounts set name = 'RAZORPAY Bank Gurdaspur branch-912010045330868' where glcode='4502001';
update bankaccount set narration ='acc_FUyHcpqaI9NLXv' where accountnumber='912010045330868';
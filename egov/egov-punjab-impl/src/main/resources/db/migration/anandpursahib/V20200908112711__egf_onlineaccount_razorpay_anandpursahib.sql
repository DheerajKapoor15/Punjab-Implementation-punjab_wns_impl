...
update chartofaccounts set name = 'RAZORPAY Bank Anandpursahib branch-912010014043283' where glcode='4502101';

update bankaccount set narration ='acc_FaSSQi6pvjwza0' where accountnumber='912010014043283';
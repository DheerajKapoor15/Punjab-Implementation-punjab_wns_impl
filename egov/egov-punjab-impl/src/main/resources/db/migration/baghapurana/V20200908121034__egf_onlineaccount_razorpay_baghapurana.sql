...
update chartofaccounts set name = 'RAZORPAY Bank Baghapurana branch-479010100011468' where glcode='4502001';
update bankaccount set narration ='acc_FSZsnlIrlM98dO' where accountnumber='479010100011468';
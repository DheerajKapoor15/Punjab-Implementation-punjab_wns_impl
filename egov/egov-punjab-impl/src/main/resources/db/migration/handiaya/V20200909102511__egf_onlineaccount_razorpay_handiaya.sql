...
update chartofaccounts set name = 'RAZORPAY Bank Handiaya branch-917010084676591' where glcode='4502101';
update bankaccount set narration ='acc_FSagEin8dRFprI' where accountnumber='917010084676591';
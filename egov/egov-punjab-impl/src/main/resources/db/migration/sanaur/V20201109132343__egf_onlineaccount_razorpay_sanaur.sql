...
update chartofaccounts set name = 'RAZORPAY Bank Sanaur branch-917010069586099' where glcode='4502001';
update bankaccount set narration ='acc_G4YgzEN13inUQf' where accountnumber='917010069586099';  
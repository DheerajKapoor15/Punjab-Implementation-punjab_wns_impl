...
update chartofaccounts set name = 'RAZORPAY  Bank Mahilpur branch-918010049061216' where glcode='4502001';
update bankaccount set narration ='acc_FSymViWDz1CrSR' where accountnumber='918010049061216';
...
update chartofaccounts set name = 'RAZORPAY Bank Abohar branch-918010083154826' where glcode='4502001';
update bankaccount set narration ='acc_FUxYJ4Ke4isr0F' where accountnumber='918010083154826';

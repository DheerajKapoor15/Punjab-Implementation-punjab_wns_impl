...
update chartofaccounts set name = 'RAZORPAY Bank Moga branch-918010078173353' where glcode='4502001';
update bankaccount set narration ='acc_FUyYxwKfrACyTx' where accountnumber='918010078173353';
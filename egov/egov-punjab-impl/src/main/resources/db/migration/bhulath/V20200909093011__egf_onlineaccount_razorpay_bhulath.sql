...
update chartofaccounts set name = 'RAZORPAY Bank Bhulath branch-918010059789386' where glcode='4502001';
update bankaccount set narration ='acc_FUyNSuzKjvlHmy' where accountnumber='918010059789386';

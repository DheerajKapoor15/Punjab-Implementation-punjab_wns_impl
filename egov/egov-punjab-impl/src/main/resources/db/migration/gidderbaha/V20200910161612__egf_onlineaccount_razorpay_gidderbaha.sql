...
update chartofaccounts set name = 'RAZORPAY Bank Gidderbaha branch-918020078222083' where glcode='4502101';
update bankaccount set narration ='acc_FasiNbGVz2EgUu' where accountnumber='918020078222083';
...
update chartofaccounts set name = 'RAZORPAY Bank Sangat Mandi branch-918010058959151' where glcode='4502101';
update bankaccount set narration ='acc_FVkNzcsfW3TVDO' where accountnumber='918010058959151';  
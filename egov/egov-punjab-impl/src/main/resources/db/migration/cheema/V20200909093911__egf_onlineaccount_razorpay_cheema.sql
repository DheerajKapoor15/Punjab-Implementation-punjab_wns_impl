...
update chartofaccounts set name = 'RAZORPAY Axis Bank Cheema branch-918010071906493' where glcode='4502101';
update bankaccount set narration ='acc_FaTwdumjN3zkSe' where accountnumber='918010071906493';
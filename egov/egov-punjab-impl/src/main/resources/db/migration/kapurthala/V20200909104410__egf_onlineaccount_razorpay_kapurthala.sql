...
update chartofaccounts set name = 'RAZORPAY Bank Kapurthala branch-918010074111836' where glcode='4502001';
update bankaccount set narration ='acc_FUyLh6yazKwvw3' where accountnumber='918010074111836';
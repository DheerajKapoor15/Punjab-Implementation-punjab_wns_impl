...
update chartofaccounts set name = 'RAZORPAY Bank Payal branch-918010041865944' where glcode='4502101';
update bankaccount set narration ='acc_G4UTghuKJqlN9Q' where accountnumber='918010041865944';

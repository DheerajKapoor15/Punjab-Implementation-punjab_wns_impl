...
update chartofaccounts set name = 'RAZORPAY Bank Sultanpur Lodhi branch-918010030423773' where glcode='4502001';
update bankaccount set narration ='acc_FUYxqXEMzCOGSF' where accountnumber='918010030423773';
set search_path to bhawanigarh;
...
update chartofaccounts set name = 'RAZORPAY Bank Bhawanigarh branch-918010086286296' where glcode='4502001';
update bankaccount set narration ='acc_FaTVNY5Lrp5O1U' where accountnumber='918010086286296';
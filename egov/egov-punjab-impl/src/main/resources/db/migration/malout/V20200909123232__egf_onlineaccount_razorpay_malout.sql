...
update chartofaccounts set name = 'RAZORPAY Bank Malout branch-918020073181864' where glcode='4502101';
update bankaccount set narration ='acc_FUyUO6EgrpWQLQ' where accountnumber='918020073181864';
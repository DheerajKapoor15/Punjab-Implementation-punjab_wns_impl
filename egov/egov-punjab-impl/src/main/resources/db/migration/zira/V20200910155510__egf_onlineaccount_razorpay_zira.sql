...
update chartofaccounts set name = 'RAZORPAY  Bank Zira branch-916010087189677' where glcode='4502001';
update bankaccount set narration ='acc_FUZ5SiHb0MHPIn' where accountnumber='916010087189677';
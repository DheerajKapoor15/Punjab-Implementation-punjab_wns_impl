...
set search_path to fatehgarhchurian;
...
update chartofaccounts set name = 'RAZORPAY Bank FatehgarhChurian branch-920010039458009' where glcode='4502001';
update bankaccount set narration ='' where accountnumber='920010039458009';

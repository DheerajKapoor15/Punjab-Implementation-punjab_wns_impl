...
update chartofaccounts set name = 'RAZORPAY Bank Guru Harsahai branch-918010099916494' where glcode='4502001';
update bankaccount set narration ='acc_FVkXfOSrE4ZLiK' where accountnumber='918010099916494';
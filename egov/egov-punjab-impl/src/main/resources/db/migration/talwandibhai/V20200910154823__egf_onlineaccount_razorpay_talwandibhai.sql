...
update chartofaccounts set name = 'RAZORPAY Bank TalwandiBhai branch-918010047938471' where glcode='4502101';
update bankaccount set narration ='acc_FUYzDAH7lvsSQG' where accountnumber='918010047938471';
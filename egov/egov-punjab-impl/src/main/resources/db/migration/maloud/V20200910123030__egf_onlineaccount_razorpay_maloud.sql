...
update chartofaccounts set name = 'RAZORPAY  Bank Maloud branch-917010065132270' where glcode='4502101';
update bankaccount set narration ='acc_FatC8GwFys41mM' where accountnumber='917010065132270';
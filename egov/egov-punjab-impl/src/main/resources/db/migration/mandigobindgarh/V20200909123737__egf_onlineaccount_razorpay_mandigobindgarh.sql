...
update chartofaccounts set name = 'RAZORPAY Bank Mandi Gobindgarh branch-761010100002578' where glcode='4502001';
update bankaccount set narration ='acc_FSyqAUEAeAkDD1' where accountnumber='761010100002578';
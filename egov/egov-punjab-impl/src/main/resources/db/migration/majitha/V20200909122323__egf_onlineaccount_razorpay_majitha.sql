...
update chartofaccounts set name = 'RAZORPAY Bank Majitha branch-918020064608729' where glcode='4502101';
update bankaccount set narration ='' where accountnumber='918020064608729';
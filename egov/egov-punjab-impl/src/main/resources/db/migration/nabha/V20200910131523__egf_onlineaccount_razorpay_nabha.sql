...
update chartofaccounts set name = 'RAZORPAY Bank Nabha branch-918010094611219' where glcode='4502001';
update bankaccount set narration ='acc_FPPNeFhKxCvU5y' where accountnumber='918010094611219';
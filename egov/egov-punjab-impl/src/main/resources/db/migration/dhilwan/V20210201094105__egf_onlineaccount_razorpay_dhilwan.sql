...
update chartofaccounts set name = 'RAZORPAY Axis Bank Dhilwan branch-918010001563387' where glcode='4502001';
update bankaccount set narration ='' where accountnumber='918010001563387';
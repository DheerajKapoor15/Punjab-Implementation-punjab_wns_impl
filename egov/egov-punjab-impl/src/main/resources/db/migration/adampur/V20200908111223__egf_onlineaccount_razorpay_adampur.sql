...
update chartofaccounts set name = 'RAZORPAY Bank Adampur branch-918010045705992' where glcode='4502001';
update bankaccount set narration ='acc_FaQgygot9cPqQh' where accountnumber='918010045705992';
...
update chartofaccounts set name = 'RAZORPAY Bank Banur branch-918010104010302' where glcode='4502001';
update bankaccount set narration ='acc_FaSZlNQNVdiimF' where accountnumber='918010104010302';
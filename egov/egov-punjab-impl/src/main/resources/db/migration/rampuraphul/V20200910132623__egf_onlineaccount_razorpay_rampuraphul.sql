...
update chartofaccounts set name = 'RAZORPAY Bank Rampura Phul branch-918010089720700' where glcode='4502001';
update bankaccount set narration ='acc_FVkStxqMLQxsPA' where accountnumber='918010089720700';
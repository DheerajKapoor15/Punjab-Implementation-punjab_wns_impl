...
update chartofaccounts set name = 'RAZORPAY Bank Talwara branch-915010018734111' where glcode='4502101';
update bankaccount set narration ='acc_GPAHPXdJfX4H1z' where accountnumber='915010018734111';
...
update chartofaccounts set name = 'RAZORPAY Bank Budhlada branch-918010060125094' where glcode='4502101';
update bankaccount set narration ='acc_FaTYuiDojqhW1o' where accountnumber='918010060125094';
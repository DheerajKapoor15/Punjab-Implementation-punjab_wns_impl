...
update chartofaccounts set name = 'RAZORPAY Bank Banga branch-918020069671133' where glcode='4502101';
update bankaccount set narration ='acc_FaSWaqnNLnx2x3' where accountnumber='918020069671133';
...
update chartofaccounts set name = 'RAZORPAY Bank Begowal branch-911010009599972' where glcode='4502001';
update bankaccount set narration ='acc_FaTShe4xMpQS4m' where accountnumber='911010009599972';

...
update chartofaccounts set name = 'RAZORPAY Bank Sardulgarh branch-918010059536056' where glcode='4502101';
update bankaccount set narration ='acc_GWeqbP1Mm0Xg6g' where accountnumber='918010059536056';
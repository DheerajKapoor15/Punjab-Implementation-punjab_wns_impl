...
BEGIN
	...
	if(v_connectiontype is not null and v_connectiontype = 'METERED' and v_billingtype is not null and v_billingtype = 'STANDARD' ) then
		...
		select unitsconsumed,meterstatus into v_unitsconsumed,v_meterstatus from egwtr_meter_connection_details where connectionDetailsId=conn_detail_id and installment=in_curr_inst_id;

	  	...
	  	loop
			begin
				raise notice 'Started bill generation for consumercode: %',rec.shsc_number;
	    			...
	    			v_temp := stms_bill_genaration_for_consumer_code(rec.shsc_number,rec.connid,rec.conndetid, in_curr_inst_id, in_prev_inst_id,curr_installment_description,rec.locationid,rec.appdetid);

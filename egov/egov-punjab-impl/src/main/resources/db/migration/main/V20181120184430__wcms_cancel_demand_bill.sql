--Water cancel demand
create or replace FUNCTION pbwc_cancelwaterdemand(in_consumercode IN varchar(50), in_billingcycle IN varchar(50))  
...
create or replace FUNCTION pbwc_cancelwaterbill(in_consumercode IN varchar(50), in_billingcycle IN varchar(50))  
RETURNS numeric as $BODY$
declare
	v_seq_cancelreq			bigint;
	v_retval			bigint default 1;

...
BEGIN 
    ...
    select v_userpk, 'en_IN', pbsc_generateUsername(ownername), 'NOT SET', mobileno, emailid, connectiondate, connectiondate, 1, 1, TRUE, ownername, (CASE WHEN gender = 'Female' THEN 0 ELSE 1 END), 'CITIZEN', guardian, guardianrelation, dob from egswtax_stg_connection where oldconsumernumber = oldConnectionNo;

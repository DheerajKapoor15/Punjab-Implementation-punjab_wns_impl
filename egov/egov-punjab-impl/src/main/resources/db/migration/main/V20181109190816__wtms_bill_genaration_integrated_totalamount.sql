...
begin
	raise notice 'stms_penalty_and_interest_generate_for_consumercode in_consumercode, in_curr_inst_id, in_prev_inst_id, in_bill_type % % % %',in_consumercode, in_curr_inst_id, in_prev_inst_id, in_bill_type;
	v_penalty := 0;

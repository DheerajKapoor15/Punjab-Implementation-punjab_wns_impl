...
and id_demand_reason in(select id from eg_demand_reason where id_demand_reason_master in (select id from eg_demand_reason_master where code='PENALTY' and module=(select id from eg_module where name='Water Tax Management')) and id_installment in (in_curr_inst_id)) and dd.id_demand=in_demandid and dd.amount>0 and  dd.amount != dd.amt_collected;
...
and id_demand_reason in(select id from eg_demand_reason where id_demand_reason_master in (select id from eg_demand_reason_master where code='INTEREST' and module=(select id from eg_module where name='Water Tax Management')) and id_installment in (in_curr_inst_id)) and dd.id_demand=in_demandid and dd.amount>0 and  dd.amount != dd.amt_collected;

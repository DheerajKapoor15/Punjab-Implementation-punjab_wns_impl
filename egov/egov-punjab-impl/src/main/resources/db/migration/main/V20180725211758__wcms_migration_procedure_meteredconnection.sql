...
--createConnection
drop function pbwc_createConnection(varchar, bigint);
...
BEGIN
	...
	select count(*) into v_meteredconnections from egwtr_stg_connection where connectiontype='NON_METERED';
	select count(*) into v_nonmeteredconnections from egwtr_stg_connection where connectiontype='METERED';

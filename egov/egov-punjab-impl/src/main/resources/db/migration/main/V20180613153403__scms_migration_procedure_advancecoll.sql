...
drop FUNCTION pbsc_createInstDemandDetail(idDemand IN bigint, idInstall IN bigint, chargeAmt IN double precision, chargeColl IN double precision, penaltyAmt IN double precision, penaltyColl IN double precision, interestAmt IN double precision, interestColl IN double precision, idModule IN bigint, connectionDate IN date);

alter table egwtr_demandbill_view add column demandid bigint;
alter table egwtr_demandbill_view add column zone character varying(512);
alter table egwtr_demandbill_view add column block character varying(512);
alter table egwtr_demandbill_view add column locality character varying(512);

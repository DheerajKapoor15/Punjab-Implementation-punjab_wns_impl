DROP FUNCTION IF EXISTS wtms_bill_genaration(connection_type varchar,batch_name varchar,boundary_type varchar,curr_installment_description varchar, batch_id bigint);
DROP FUNCTION IF EXISTS wtms_bill_genaration_for_boundary(connection_type varchar,boundary_type varchar, in_location_id bigint, in_curr_inst_id bigint, in_prev_inst_id bigint, curr_installment_description varchar, batch_id bigint);

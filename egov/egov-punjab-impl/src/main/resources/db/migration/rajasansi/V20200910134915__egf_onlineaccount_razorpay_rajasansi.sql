...
update chartofaccounts set name = 'RAZORPAY Bank Rajasansi branch-918010080822544' where glcode='4502001';
update bankaccount set narration ='acc_FVMSfwVML7R9Ap' where accountnumber='918010080822544';
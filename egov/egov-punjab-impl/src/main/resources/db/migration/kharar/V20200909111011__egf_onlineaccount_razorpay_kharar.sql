...
update chartofaccounts set name = 'RAZORPAY Bank Kharar branch-918010084502756' where glcode='4502001';
update bankaccount set narration ='acc_FSaoPSn8OHULAU' where accountnumber='918010084502756';
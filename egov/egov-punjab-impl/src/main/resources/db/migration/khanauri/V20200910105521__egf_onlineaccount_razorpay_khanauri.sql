...
update chartofaccounts set name = 'RAZORPAY Bank Khanauri branch-918010068931185' where glcode='4502101';
update bankaccount set narration ='acc_FaszpJApS5qcZG' where accountnumber='918010068931185';
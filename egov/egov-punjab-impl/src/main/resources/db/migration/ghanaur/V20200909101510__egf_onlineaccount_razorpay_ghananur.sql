...
update chartofaccounts set name = 'RAZORPAY  Bank Ghanaur branch-913010015912785' where glcode='4502101';
update bankaccount set narration ='' where accountnumber='913010015912785';
...
update chartofaccounts set name = 'RAZORPAY Bank Bhogpur branch-918010056289047' where glcode='4502001';
update bankaccount set narration ='acc_FSa4jg7xQ22BmF' where accountnumber='918010056289047';

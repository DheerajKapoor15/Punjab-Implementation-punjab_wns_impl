...
update chartofaccounts set name = 'RAZORPAY Bank Shahkot branch-918010058512121' where glcode='4502001';
update bankaccount set narration ='acc_FUYvR0lum6go4z' where accountnumber='918010058512121';
...
--collection
insert into eg_roleaction (roleid,actionid) values ((select id from eg_role where name='PWSSB User'), (select id from eg_action where url='/receipts/receipt-newform.action' and contextroot='collection' and displayname='CreateReceipt'));
insert into eg_roleaction (roleid,actionid) values ((select id from eg_role where name='PWSSB User'), (select id from eg_action where url='/receipts/receipt-save.action' and contextroot='collection'));
insert into eg_roleaction (roleid,actionid) values ((select id from eg_role where name='PWSSB User'), (select id from eg_action where name='GetAllBankName' and url='/voucher/common-ajaxGetAllBankName.action' and contextroot='EGF'));

...
update chartofaccounts set name = 'RAZORPAY Bank Barnala branch-917010038563443' where glcode='4502001';

update bankaccount set narration ='acc_FUxf7vcYkOF9lh' where accountnumber='917010038563443';

...
update chartofaccounts set name = 'RAZORPAY Bank Shamchurasi branch-918010045705989' where glcode='4502001';
update bankaccount set narration ='acc_G4UH3mhdJZj2dB' where accountnumber='918010045705989';
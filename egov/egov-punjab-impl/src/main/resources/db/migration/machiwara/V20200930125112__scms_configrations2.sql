...
update eg_appconfig_values set value='SEWERAGE_EQUAL_TO_WATER' where key_id = (select id from eg_appconfig where key_name='TAX_RATETYPE' and module=(select id from eg_module where name='Sewerage Tax Management'));

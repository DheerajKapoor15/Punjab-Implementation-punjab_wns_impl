...
update chartofaccounts set name = 'RAZORPAY Bank Machiwara branch-918010041865928' where glcode='4502101';
update bankaccount set narration ='acc_FatA0MFdGgQOOa' where accountnumber='918010041865928';
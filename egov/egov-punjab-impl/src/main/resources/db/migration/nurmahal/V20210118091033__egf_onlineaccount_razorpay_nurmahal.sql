...
update chartofaccounts set name = 'RAZORPAY Bank Nurmahal branch-918010104595612' where glcode='4502101';
update bankaccount set narration ='acc_GP9OkBvyzo3nRl' where accountnumber='918010104595612';
...
update chartofaccounts set name = 'RAZORPAY Bank Badhnikalan branch-918010043182175' where glcode='4502001';
update bankaccount set narration ='acc_FaSTnQQpkpT9OM' where accountnumber='918010043182175';

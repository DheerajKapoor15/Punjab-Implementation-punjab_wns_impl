...
update chartofaccounts set name = 'RAZORPAY Bank Dhariwal branch-918020092010143' where glcode='4502001';
update bankaccount set narration ='acc_FSaEUrBjFDzanw' where accountnumber='918020092010143';
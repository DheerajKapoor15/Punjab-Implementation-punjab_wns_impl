...
update chartofaccounts set name = 'RAZORPAY Bank Ramdass branch-918020062415109' where glcode='4502101';
update bankaccount set narration ='acc_FVMRFIVKx8h1jV' where accountnumber='918020062415109';
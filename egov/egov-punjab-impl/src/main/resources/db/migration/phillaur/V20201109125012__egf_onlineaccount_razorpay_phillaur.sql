...
update chartofaccounts set name = 'RAZORPAY Bank Phillaur branch-918010065063207' where glcode='4502101';
update bankaccount set narration ='acc_G4U1WOYV9AyR6n' where accountnumber='918010065063207';
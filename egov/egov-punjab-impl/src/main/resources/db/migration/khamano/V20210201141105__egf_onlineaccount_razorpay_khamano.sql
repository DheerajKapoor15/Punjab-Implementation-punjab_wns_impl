...
update chartofaccounts set name = 'RAZORPAY Khamano branch-917010074692419' where glcode='4502001';
update bankaccount set narration ='acc_FUyOet8ii9jNoB' where accountnumber='917010074692419';
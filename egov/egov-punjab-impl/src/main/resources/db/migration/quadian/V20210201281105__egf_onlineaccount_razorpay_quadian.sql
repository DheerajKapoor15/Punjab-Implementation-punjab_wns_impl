...
update chartofaccounts set name = 'RAZORPAY Bank Quadian branch-920010040378709' where glcode='4502101';
update bankaccount set narration ='acc_G4VIRglJ7P8Ova' where accountnumber='920010040378709';
...
update chartofaccounts set name = 'RAZORPAY Bank Kartarpur branch-911010037250630' where glcode='4502001';
update bankaccount set narration ='' where accountnumber='911010037250630';
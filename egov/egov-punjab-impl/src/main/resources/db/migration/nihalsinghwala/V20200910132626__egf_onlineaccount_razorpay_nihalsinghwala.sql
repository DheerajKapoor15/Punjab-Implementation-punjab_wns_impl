...
update chartofaccounts set name = 'RAZORPAY Bank Nihal Singh Wala branch-918010091735628' where glcode='4502001';
update bankaccount set narration ='acc_FUygFNN1nOnQjR' where accountnumber='918010091735628';
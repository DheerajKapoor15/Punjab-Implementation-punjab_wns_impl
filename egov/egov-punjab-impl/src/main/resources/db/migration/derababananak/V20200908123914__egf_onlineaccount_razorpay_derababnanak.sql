...
update chartofaccounts set name = 'RAZORPAY Bank Dera Baba Nanak branch-912010029354785' where glcode='4502001';
update bankaccount set narration ='acc_FVkaeKJN4eCJII' where accountnumber='912010029354785';
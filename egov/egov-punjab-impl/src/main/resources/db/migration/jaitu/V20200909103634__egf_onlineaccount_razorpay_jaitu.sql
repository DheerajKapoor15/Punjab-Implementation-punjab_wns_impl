...
update chartofaccounts set name = 'RAZORPAY Bank Jaitu branch-918010043172945' where glcode='4502101';
update bankaccount set narration ='acc_FVkVkf1oieZGq6' where accountnumber='918010043172945';
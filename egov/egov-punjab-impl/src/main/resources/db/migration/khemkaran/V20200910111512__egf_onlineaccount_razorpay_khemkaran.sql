...
update chartofaccounts set name = 'RAZORPAY Bank Kennedy avenue-918020061741715' where glcode='4502101';
update bankaccount set narration ='acc_Fat1ityc4KsmFq' where accountnumber='918020061741715';
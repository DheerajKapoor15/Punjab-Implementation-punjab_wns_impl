...
update chartofaccounts set name = 'RAZORPAY Bank Samana branch-918010063773560' where glcode='4502101';
update bankaccount set narration ='acc_GP9T2cP9XPdokJ' where accountnumber='918010063773560';
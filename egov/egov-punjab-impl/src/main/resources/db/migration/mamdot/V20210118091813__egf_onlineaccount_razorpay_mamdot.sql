...
update chartofaccounts set name = 'RAZORPAY Bank Mamdot branch-919010006289340' where glcode='4502001';
update bankaccount set narration ='acc_GPAVt72MiNwYDV' where accountnumber='919010006289340';
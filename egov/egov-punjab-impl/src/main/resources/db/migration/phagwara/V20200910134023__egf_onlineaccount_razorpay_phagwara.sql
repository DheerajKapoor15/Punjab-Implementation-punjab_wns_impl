...
update chartofaccounts set name = 'RAZORPAY Bank Phagwara branch-919010041317688' where glcode='4502101';
update bankaccount set narration ='acc_FUyn56cl0LPLgm' where accountnumber='919010041317688';

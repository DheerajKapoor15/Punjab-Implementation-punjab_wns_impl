...
update chartofaccounts set name = 'RAZORPAY Bank Bareta branch-918010060120635' where glcode='4502101';
update bankaccount set narration ='acc_FaSauW0LR7Rq1z' where accountnumber='918010060120635';
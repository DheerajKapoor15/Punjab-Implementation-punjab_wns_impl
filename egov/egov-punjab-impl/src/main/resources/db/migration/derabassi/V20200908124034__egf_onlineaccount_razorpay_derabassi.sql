...
update chartofaccounts set name = 'RAZORPAY Bank DeraBassi branch-303010100073741' where glcode='4502001';
update bankaccount set narration ='acc_FUxjzM8NX23ss8' where accountnumber='303010100073741';
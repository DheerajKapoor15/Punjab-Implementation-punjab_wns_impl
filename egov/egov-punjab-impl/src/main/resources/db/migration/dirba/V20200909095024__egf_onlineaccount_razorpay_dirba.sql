...
update chartofaccounts set name = 'RAZORPAY Bank Dirba branch-918010069713418' where glcode='4502101';
update bankaccount set narration ='acc_FaUmpmXPqxaQHu' where accountnumber='918010069713418';
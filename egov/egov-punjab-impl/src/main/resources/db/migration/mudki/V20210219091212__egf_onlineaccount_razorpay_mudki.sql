...
update chartofaccounts set name = 'RAZORPAY  Bank Mudki branch-918010047938507' where glcode='4502001';
update bankaccount set narration ='acc_GccXWXkB3ztSk1' where accountnumber='918010047938507';

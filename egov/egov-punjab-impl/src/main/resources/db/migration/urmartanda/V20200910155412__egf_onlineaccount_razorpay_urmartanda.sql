...
update chartofaccounts set name = 'RAZORPAY  Bank UrmarTanda branch-918010032988944' where glcode='4502001';
update bankaccount set narration ='acc_FUZ1Qsr8eKVWvj' where accountnumber='918010032988944';
...
update chartofaccounts set name = 'RAZORPAY Bank Mansa branch-918010060121434' where glcode='4502001';
update bankaccount set narration ='acc_FUyWBTxCjVdPrF' where accountnumber='918010060121434';
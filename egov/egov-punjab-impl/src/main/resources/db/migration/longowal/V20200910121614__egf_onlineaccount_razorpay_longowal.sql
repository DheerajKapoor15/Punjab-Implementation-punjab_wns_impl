...
update chartofaccounts set name = 'RAZORPAY Bank Sangarur branch-917010054559439' where glcode='4502101';
update bankaccount set narration ='acc_Fat84V4lvMYC1I' where accountnumber='917010054559439';
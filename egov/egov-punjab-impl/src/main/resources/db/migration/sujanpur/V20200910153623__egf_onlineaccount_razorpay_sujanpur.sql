...
update chartofaccounts set name = 'RAZORPAY  Bank Sujanpur branch-918010075369168' where glcode='4502001';
update bankaccount set narration ='acc_FUYwehuc9cGgyn' where accountnumber='918010075369168';
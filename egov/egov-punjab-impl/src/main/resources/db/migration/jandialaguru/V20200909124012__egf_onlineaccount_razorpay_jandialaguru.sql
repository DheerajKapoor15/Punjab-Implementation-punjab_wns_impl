...
update chartofaccounts set name = 'RAZORPAY Bank Jandiala Guru branch-918020064167998' where glcode='4502101';
update bankaccount set narration ='acc_Fasx8NR3YlJVif' where accountnumber='918020064167998';
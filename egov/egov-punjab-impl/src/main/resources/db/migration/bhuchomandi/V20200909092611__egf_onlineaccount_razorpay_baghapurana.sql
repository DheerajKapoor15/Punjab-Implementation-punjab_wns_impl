...
update chartofaccounts set name = 'RAZORPAY Bank Bhucho Mandi branch-918010058959148' where glcode='4502101';
update bankaccount set narration ='acc_FVMgMWZT942IwN' where accountnumber='918010058959148';
...
update chartofaccounts set name = 'RAZORPAY Bank Amloh branch-918010085412618' where glcode='4502001';

update bankaccount set narration ='acc_FSZp4brIKYtKJU' where accountnumber='918010085412618';
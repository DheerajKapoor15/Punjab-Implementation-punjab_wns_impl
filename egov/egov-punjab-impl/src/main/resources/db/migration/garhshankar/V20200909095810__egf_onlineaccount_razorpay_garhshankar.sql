...
update chartofaccounts set name = 'RAZORPAY Bank Garhshankar branch-918010069824848' where glcode='4502001';
update bankaccount set narration ='acc_FVki0Rj3ZBJiNH' where accountnumber='918010069824848';
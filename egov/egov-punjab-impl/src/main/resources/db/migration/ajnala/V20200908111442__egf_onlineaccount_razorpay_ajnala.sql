...
update chartofaccounts set name = 'RAZORPAY Bank Ajnala branch-918020064167406' where glcode='4502101';
update bankaccount set narration ='acc_FVMPekTQ3dvwPg' where accountnumber='918020064167406';
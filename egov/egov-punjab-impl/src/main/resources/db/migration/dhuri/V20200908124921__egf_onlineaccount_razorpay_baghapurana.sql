...
update chartofaccounts set name = 'RAZORPAY Bank Dhuri branch-918010076347259' where glcode='4502101';
update bankaccount set narration ='acc_FUyC4I4fb6vwVx' where accountnumber='918010076347259';
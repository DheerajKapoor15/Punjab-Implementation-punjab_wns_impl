...
update chartofaccounts set name = 'RAZORPAY Bank Bassi Pathana branch-918020072595347' where glcode='4502101';
update bankaccount set narration ='acc_FaSdMZt73GAg94' where accountnumber='918020072595347';
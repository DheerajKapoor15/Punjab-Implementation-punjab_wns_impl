...
update chartofaccounts set name = 'RAZORPAY Bank Raikot branch-918010047489461' where glcode='4502001';
update bankaccount set narration ='acc_FUYsADXSER82ZN' where accountnumber='918010047489461';
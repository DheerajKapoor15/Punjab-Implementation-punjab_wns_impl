...
update chartofaccounts set name = 'RAZORPAY Bank Dasuya branch-915020003642189' where glcode='4502001';
update bankaccount set narration ='acc_FSaCK8I0F9G6xo' where accountnumber='915020003642189';
...
update chartofaccounts set name = 'RAZORPAY Bank Bariwala branch-918010080002779' where glcode='4502101';
update bankaccount set narration ='acc_FaScIEizMXSD2M' where accountnumber='918010080002779';
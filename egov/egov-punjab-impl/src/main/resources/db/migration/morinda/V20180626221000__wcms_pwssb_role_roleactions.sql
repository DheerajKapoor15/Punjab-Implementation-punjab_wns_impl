INSERT INTO eg_role(id, name, description, createddate, createdby, lastmodifiedby, lastmodifieddate, version) VALUES (nextval('seq_eg_role'), 'PWSSB User', 'One who can access the Water and Sewerage services for citizen under PWSSB', now(), 1, 1, now(), 0);

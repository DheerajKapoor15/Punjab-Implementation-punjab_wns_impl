...
update chartofaccounts set name = 'RAZORPAY Bank Morinda branch-"918020069267912' where glcode='4502101';
update bankaccount set narration ='acc_GCtN0TiSxbSKKl' where accountnumber='918020069267912';

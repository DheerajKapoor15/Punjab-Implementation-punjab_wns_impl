...
update chartofaccounts set name = 'RAZORPAY Bank Doraha branch-918010077797693' where glcode='4502001';

update bankaccount set narration ='acc_FSaK2X9n0ERc5B' where accountnumber='918010077797693';
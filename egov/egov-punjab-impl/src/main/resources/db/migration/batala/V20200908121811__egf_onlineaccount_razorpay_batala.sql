...
update chartofaccounts set name = 'RAZORPAY Bank Batala branch-917020037709908' where glcode='4502001';
update bankaccount set narration ='acc_FVkcVZwAzR7wd2' where accountnumber='917020037709908';
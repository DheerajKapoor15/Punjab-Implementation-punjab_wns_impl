...
update eg_appconfig_values set value='4' where key_id = (select id from eg_appconfig where key_name='PANALTY_PERCENTAGE' and module=(select id from eg_module where name='Water Tax Management'));

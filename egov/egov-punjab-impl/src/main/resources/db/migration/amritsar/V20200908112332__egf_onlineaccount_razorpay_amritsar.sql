...
update chartofaccounts set name = 'RAZORPAY Bank Amritsar branch-919020079177356' where glcode='4502001';
update bankaccount set narration ='acc_FUxaM6Q7m3qM1w' where accountnumber='919020079177356';
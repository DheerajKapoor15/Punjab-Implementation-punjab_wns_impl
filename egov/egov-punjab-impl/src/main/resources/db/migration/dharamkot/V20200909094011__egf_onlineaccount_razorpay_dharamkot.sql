...
update chartofaccounts set name = 'RAZORPAY Bank Dharamkot branch-918010019751240' where glcode='4502001';
update bankaccount set narration ='acc_FaUifsQJoiLywO' where accountnumber='918010019751240';
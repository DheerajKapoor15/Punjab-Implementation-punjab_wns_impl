...
update chartofaccounts set name = 'RAZORPAY Bank Ahmedgarh branch-918010087741583' where glcode='4502001';
update bankaccount set narration ='acc_FSZlGVv7ueuBGQ' where accountnumber='918010087741583';
...
update chartofaccounts set name = 'RAZORPAY Bank Garhdiwala branch-917010060767099' where glcode='4502001';
update bankaccount set narration ='acc_FVki0Rj3ZBJiNH' where accountnumber='917010060767099';
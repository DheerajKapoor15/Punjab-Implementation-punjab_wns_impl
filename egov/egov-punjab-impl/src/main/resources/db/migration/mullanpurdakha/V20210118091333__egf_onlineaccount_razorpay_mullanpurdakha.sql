...
update chartofaccounts set name = 'RAZORPAY Bank MullanpurDakha branch-917010065132238' where glcode='4502101';
update bankaccount set narration ='acc_GP9c4t4FwGgSJE' where accountnumber='917010065132238';

...
update chartofaccounts set name = 'RAZORPAY Bank Mukerian branch-917010060965068' where glcode='4502001';
update bankaccount set narration ='acc_FSz2DB6djX3Hvf' where accountnumber='917010060965068';

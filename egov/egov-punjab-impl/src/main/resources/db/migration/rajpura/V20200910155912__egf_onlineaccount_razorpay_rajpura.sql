...
update chartofaccounts set name = 'RAZORPAY Bank Rajpura branch-918010078239916' where glcode='4502101';
update bankaccount set narration ='acc_FVLpPg1hl2hO5T' where accountnumber='918010078239916';
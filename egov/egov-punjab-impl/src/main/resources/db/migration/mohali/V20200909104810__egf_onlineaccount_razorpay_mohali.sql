...
update chartofaccounts set name = 'RAZORPAY Nationalised Banks-State Bank of India-918010097736982' where glcode='4502101';
update bankaccount set narration ='acc_FUyc1qMl2Dtckq' where accountnumber='918010097736982';
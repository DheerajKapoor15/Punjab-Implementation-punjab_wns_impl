...
update chartofaccounts set name = 'RAZORPAY Bank Alawalpur branch-918010078661805' where glcode='4502001';

update bankaccount set narration ='acc_FaSHcOSdhvJB2G' where accountnumber='918010078661805';

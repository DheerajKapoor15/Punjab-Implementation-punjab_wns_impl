...
update chartofaccounts set name = 'RAZORPAY Bank Ghagga branch-918010084572137' where glcode='4502001';
update bankaccount set narration ='acc_FVki0Rj3ZBJiNH' where accountnumber='918010084572137';
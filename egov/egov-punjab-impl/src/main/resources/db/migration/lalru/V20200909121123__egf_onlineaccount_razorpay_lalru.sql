...
update chartofaccounts set name = 'RAZORPAY Bank Lalru branch-918010077779983' where glcode='4502001';
update bankaccount set narration ='acc_FSyhATXn9n82SQ' where accountnumber='918010077779983';
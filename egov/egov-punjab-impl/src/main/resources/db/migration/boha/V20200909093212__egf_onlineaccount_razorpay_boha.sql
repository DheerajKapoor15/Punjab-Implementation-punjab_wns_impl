...
update chartofaccounts set name = 'RAZORPAY Bank Boha branch-918010060120554' where glcode='4502101';
update bankaccount set narration ='acc_FUyXUvKZdId4Cs' where accountnumber='918010060120554';

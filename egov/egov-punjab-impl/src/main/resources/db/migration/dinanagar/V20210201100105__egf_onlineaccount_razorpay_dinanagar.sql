...
update chartofaccounts set name = 'RAZORPAY Bank Dina Nagar branch-918020071862983' where glcode='4502101';

update bankaccount set narration ='' where accountnumber='918020071862983';
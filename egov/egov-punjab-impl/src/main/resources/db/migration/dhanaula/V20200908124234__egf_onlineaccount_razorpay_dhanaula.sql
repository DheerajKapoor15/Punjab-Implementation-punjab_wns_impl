...
update chartofaccounts set name = 'RAZORPAY Bank Dhanaula branch-918010098477606' where glcode='4502001';
update bankaccount set narration ='acc_FVMa4srSHfskmT' where accountnumber='918010098477606';
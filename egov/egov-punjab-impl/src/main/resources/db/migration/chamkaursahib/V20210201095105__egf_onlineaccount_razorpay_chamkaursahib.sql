...
update chartofaccounts set name = 'RAZORPAY Nationalised Banks-State Bank of India' where glcode='4502101';
update bankaccount set narration ='' where accountnumber='';
...
update chartofaccounts set name = 'RAZORPAY Bank Bhikhi branch-918010060124666' where glcode='4502101';
update bankaccount set narration ='acc_FaTXaOWPbQdYjT' where accountnumber='918010060124666';

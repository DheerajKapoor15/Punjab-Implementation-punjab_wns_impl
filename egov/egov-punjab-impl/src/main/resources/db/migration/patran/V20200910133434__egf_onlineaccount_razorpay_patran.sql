...
update chartofaccounts set name = 'RAZORPAY  Bank Patran branch-918010059279481' where glcode='4502001';
update bankaccount set narration ='acc_FUYpTX0zvoK2nX' where accountnumber='918010059279481';

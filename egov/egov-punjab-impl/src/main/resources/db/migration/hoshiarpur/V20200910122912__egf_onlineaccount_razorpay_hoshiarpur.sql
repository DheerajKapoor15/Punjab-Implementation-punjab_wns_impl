...
update chartofaccounts set name = 'RAZORPAY Bank Hoshiarpur branch-919010038226258' where glcode='4502001';
update bankaccount set narration ='acc_FasouONpv2C5dd' where accountnumber='919010038226258';
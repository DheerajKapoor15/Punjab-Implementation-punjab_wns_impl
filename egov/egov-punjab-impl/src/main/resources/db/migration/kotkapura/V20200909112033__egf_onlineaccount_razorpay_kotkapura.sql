...
update chartofaccounts set name = 'RAZORPAY Bank Kotkapura branch-918020070314047' where glcode='4502101';
update bankaccount set narration ='acc_FUyQMX0cbFkBBh' where accountnumber='918020070314047';
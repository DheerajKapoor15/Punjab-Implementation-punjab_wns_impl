...
update chartofaccounts set name = 'RAZORPAY Bank Raman branch-918010089674490' where glcode='4502101';
update bankaccount set narration ='acc_FVMenj20QpL1UY' where accountnumber='918010089674490';
...
update chartofaccounts set name = 'RAZORPAY Bank Moonak branch-918010052140193' where glcode='4502001';
update bankaccount set narration ='' where accountnumber='918010052140193';

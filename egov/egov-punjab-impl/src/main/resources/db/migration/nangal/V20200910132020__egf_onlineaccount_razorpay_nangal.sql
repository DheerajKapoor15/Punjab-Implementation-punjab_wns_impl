...
update chartofaccounts set name = 'RAZORPAY Bank Nangal branch-917010034969131' where glcode='4502001';
update bankaccount set narration ='acc_FSzB3rWVgEmZX5' where accountnumber='917010034969131';
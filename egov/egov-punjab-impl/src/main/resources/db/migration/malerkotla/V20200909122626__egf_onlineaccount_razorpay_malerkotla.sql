...
update chartofaccounts set name = 'RAZORPAY Bank Malerkotla branch-919010016986866' where glcode='4502101';
update bankaccount set narration ='acc_FUyT2NWdqk72qE' where accountnumber='919010016986866';
...
update chartofaccounts set name = 'RAZORPAY Bank Talwandi sabo branch-919010062684910' where glcode='4502001';
update bankaccount set narration ='acc_G4UJcBKlFo8auc' where accountnumber='919010062684910';
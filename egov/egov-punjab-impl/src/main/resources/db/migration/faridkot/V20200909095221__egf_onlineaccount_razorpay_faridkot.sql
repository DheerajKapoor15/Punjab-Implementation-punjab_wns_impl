...
update chartofaccounts set name = 'RAZORPAY Bank Faridkot branch-918010070694663' where glcode='4502101';

update bankaccount set narration ='acc_FaUocvznCLCnOo' where accountnumber='918010070694663';
...
update chartofaccounts set name = 'Axis Bank Ropar branch-918010082843464' where glcode='4502001';
update bankaccount set narration ='acc_FVM357mbH6OZbD' where accountnumber='918010082843464';

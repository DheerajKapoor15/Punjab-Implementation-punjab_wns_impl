...
values(nextval('seq_bankbranch'),'001','Ferozepur Punjab(Mallanwala)','ES-30/3, HARJI NIWAS , 1-THE MALL,FEROZEPUR CITY','FEROZEPUR',(select id from bank where code='UTIB'),true,now(),now(),1,0,1);
...
INSERT INTO chartofaccounts (id,glcode,name,isactiveforposting,parentid,createddate,type,classification,functionreqd, budgetcheckreq, majorcode,
 createdby) VALUES (nextval('seq_chartofaccounts'), '4502101','Axis Bank Ferozepur (Mallanwala) branch-917010056656770',true, (select id from chartofaccounts where glcode='45021'), current_date,'A',4, false, false, '450', 1);
...
values(nextval('seq_bankaccount'),(select id from bankbranch where branchcode='001'),'917010056656770',true,

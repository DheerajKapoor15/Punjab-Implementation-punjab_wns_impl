...
update chartofaccounts set name = 'RAZORPAY Bank Ferozepur (Mallanwala) branch-917010056656770' where glcode='4502101';
update bankaccount set narration ='acc_FUyT2NWdqk72qE' where accountnumber='917010056656770';
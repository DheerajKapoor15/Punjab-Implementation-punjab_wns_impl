...
update chartofaccounts set name = 'RAZORPAY Bank Jalalabad branch-914010027316550' where glcode='4502001';
update bankaccount set narration ='acc_FSalYtgV8ji8Ah' where accountnumber='914010027316550';
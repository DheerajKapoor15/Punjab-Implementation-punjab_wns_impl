...
update chartofaccounts set name = 'RAZORPAY Bank Rahon branch-918020089315224' where glcode='4502101';
update bankaccount set narration ='acc_G4TuzUZK9k8lT8' where accountnumber='918020089315224';
...
update chartofaccounts set name = 'RAZORPAY Bank Hariana branch-918010070617059' where glcode='4502001';
update bankaccount set narration ='acc_FVkqsyOEB8vr1s' where accountnumber='918010070617059';
...
update chartofaccounts set name = 'RAZORPAY  Bank Rayya branch-912010028625925' where glcode='4502001';
update bankaccount set narration ='acc_FVMNiIAQ1YkkER' where accountnumber='912010028625925';
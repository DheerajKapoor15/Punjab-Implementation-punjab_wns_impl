...
update chartofaccounts set name = 'RAZORPAY Bank Amargarh branch-918010104802376' where glcode='4502101';
update bankaccount set narration ='acc_FaSR4Ur5JN8rMq' where accountnumber='918010104802376';

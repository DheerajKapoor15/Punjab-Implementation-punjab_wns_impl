...
update chartofaccounts set name = 'RAZORPAY  Bank TarnTaran branch-918010007271543' where glcode='4502001';
update bankaccount set narration ='acc_FUZ4Gwtb0Yv3bR' where accountnumber='918010007271543';
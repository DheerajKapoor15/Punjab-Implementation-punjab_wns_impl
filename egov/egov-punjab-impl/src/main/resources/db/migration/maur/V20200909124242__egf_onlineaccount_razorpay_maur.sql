...
update chartofaccounts set name = 'RAZORPAY Bank Maur branch-918010041091198' where glcode='4502101';
update bankaccount set narration ='acc_FVkMb3FSAPWkkz' where accountnumber='918010041091198';
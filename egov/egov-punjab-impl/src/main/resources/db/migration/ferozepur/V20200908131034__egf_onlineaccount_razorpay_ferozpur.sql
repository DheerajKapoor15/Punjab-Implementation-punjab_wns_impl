...
update chartofaccounts set name = 'RAZORPAY Bank Ferozepur branch-911010042897402' where glcode='4502001';
update bankaccount set narration ='acc_FUyFToWYdsghOJ' where accountnumber='911010042897402';
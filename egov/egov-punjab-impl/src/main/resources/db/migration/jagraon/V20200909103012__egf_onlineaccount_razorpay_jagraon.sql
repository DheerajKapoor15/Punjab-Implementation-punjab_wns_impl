...
update chartofaccounts set name = 'RAZORPAY Bank Jagraon branch-281010100087498' where glcode='4502001';
update bankaccount set narration ='acc_FSaiLgW3uhmWkD' where accountnumber='281010100087498';
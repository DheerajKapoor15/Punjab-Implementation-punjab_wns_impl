...
update chartofaccounts set name = 'RAZORPAY Bank Lehragaga branch-918010010557003' where glcode='4502001';
update bankaccount set narration ='acc_FSyiyWp9MTcc6k' where accountnumber='918010010557003';
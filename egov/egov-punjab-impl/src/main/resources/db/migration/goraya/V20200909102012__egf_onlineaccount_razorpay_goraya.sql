...
update chartofaccounts set name = 'RAZORPAY Bank Goraya branch-917010081598212' where glcode='4502001';
update bankaccount set narration ='acc_FVMmzsWLx4iysQ' where accountnumber='917010081598212';
...
update chartofaccounts set name = 'RAZORPAY Bank Kurali branch-918010085387651' where glcode='4502001';
update bankaccount set narration ='acc_FSyexY4oO7cPDE' where accountnumber='918010085387651';
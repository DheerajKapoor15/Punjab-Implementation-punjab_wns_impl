...
update chartofaccounts set name = 'RAZORPAY Bank Samrala branch-918010044039463' where glcode='4502001';
update bankaccount set narration ='acc_FVM4hQVTF0XaJp' where accountnumber='918010044039463';  
...
update chartofaccounts set name = 'RAZORPAY Bank Makhu branch-917010075267832' where glcode='4502001';
update bankaccount set narration ='acc_FSyoEhWd91PPAx' where accountnumber='917010075267832';
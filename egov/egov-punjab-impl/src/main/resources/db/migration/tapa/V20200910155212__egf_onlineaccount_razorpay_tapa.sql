...
update chartofaccounts set name = 'RAZORPAY Bank Tapa branch-917010084676614' where glcode='4502001';
update bankaccount set narration ='acc_FUZ337vqJEYQM3' where accountnumber='917010084676614';
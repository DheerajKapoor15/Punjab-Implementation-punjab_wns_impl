...
update chartofaccounts set name = 'RAZORPAY Bank Nakodar branch-919010022750219' where glcode='4502101';
update bankaccount set narration ='acc_GCtQoodEZgyIZ6' where accountnumber='919010022750219';
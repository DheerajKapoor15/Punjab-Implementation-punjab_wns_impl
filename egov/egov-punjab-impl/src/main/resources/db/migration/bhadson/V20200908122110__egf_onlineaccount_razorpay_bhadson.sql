...
update chartofaccounts set name = 'RAZORPAY Bank Bhadson branch-918010001165789' where glcode='4502001';
update bankaccount set narration ='acc_FSa1fsL17uqA6t' where accountnumber='918010001165789';

...
update chartofaccounts set name = 'RAZORPAY Bank Bhadaur branch-917010084676575' where glcode='4502101';
update bankaccount set narration ='acc_FVMby4GVvSErgK' where accountnumber='917010084676575';

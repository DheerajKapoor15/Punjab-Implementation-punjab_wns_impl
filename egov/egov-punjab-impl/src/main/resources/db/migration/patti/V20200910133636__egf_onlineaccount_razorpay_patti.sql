...
update chartofaccounts set name = 'RAZORPAY Bank Patti branch-918020079765901' where glcode='4502001';
update bankaccount set narration ='acc_FUYqlH0FsCIZ5L' where accountnumber='918020079765901';

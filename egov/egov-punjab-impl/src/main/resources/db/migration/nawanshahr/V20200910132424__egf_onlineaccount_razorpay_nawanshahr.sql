...
update chartofaccounts set name = 'RAZORPAY Bank Nawanshahr branch-912010029357823' where glcode='4502001';
update bankaccount set narration ='acc_FUyezuuDSbLN7G' where accountnumber='912010029357823';